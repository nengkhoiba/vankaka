...
<br>
<?php echo form_open('datacontroller/updatesession');?>
<div class="row">
	     			<div class="col-sm-4">
		     			<div class="form-group">
			                ...
			                <div class="input-group">
			                  ...
			                  <input id="session" name="session" type="text" class="form-control" value="<?php echo set_value('session')?>">
			                </div>
...
$(document).ready(function() {
	  ...
	  function search()
	  {
		  var url = "<?php echo site_url('datacontroller/loadDT_session?q=');?>"+document.getElementById('session').value+"&k="+document.getElementById('ddlActive').value;
		...
		function remove(id){
			if (confirm('Are you sure you want to delete?')) {
				var url = "<?php echo site_url('datacontroller/removeDT_session?id=');?>"+id;
			  	var xmlHttp = GetXmlHttpObject();
			  	if (xmlHttp != null) {
			  		try {
			  			xmlHttp.onreadystatechange=function() {
